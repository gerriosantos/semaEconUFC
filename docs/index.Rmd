...
- O `R` nem sempre aplica regras de multiplicação de matrizes. Pois, usa-se execução por elementos.
...
# (não usa a regra de nº de linhas de A deve ser igual ao nº de colunas de B)
...
knitr::include_graphics('figuras/ciclo_DS_1.png')
